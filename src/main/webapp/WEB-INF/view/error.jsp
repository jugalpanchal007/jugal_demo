...
<html lang="en">
   <head>
      <title>RRMart - Order Error</title>
   ...
   <body>
      ...
      <div class="osahan-warning bg-warning vh-100">
         <div class="p-5 text-center">
            <i class="icofont-warning-alt display-1 text-warning"></i>
            <h1 class="text-white font-weight-bold"> Your order not placed.</h1>
