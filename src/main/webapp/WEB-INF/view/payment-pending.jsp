...
<html lang="en">
   ...
   <body>
      ...
      <div class="osahan-info bg-info vh-100">
         <div class="p-5 text-center">
            <i class="icofont-check-circled display-1 text-warning"></i>
            <h1 class="text-white font-weight-bold"> Please Wait while redirecting to payment gateway.</h1>
      ...
      <div class="fixed-bottom fixed-bottom-auto bg-white rounded p-3 m-3 text-center">
         <h6 class="font-weight-bold mb-2">Do not press Back button Or Close while redirecting...!!!</h6>
      ...
      <script>
          $(document).ready(function () {
              let shortnUrl = '${shortnUrl}';

              if (shortnUrl) {
                  window.location.href=""+shortnUrl;
              } else {
