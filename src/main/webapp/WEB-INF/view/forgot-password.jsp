                  ...
                  <div class="card-body p-0">
                     ...
                     <div id="sign-in-div">
                        <div class="osahan-signin">
                           <div class="border-bottom p-3 d-flex align-items-center  justify-content-center">
                              ...
                              <%-- <a class="toggle ml-auto" href="#"><i class="icofont-ui-home"></i></a> --%>
                           ...
                           <div class="p-3">
                              <h2 class="my-0 text-center">Reset Password</h2>
                              <p class="small text-center">Enter mobile number for reset password</p>
                              <form action="get_started.html">
                                 ...
                                 <div class="form-group mt-2 text-right">
                                    <a class="text-muted  small py-2 m-2 w-100" href="/signin">Click Here to Login.</a>
                                 </div>

                                 <button type="button" id="sign-in-btn" onclick="signInBtnClickFnc()"
                                    class="btn btn-danger btn-lg rounded btn-block">Click Here to Continue</button>
                              </form>
                           </div>
                        </div>
                        <!-- footer fixed -->
                     ...
                     <div id="sign-up-div" style="display:none;">
                        <div class="osahan-signup">
                           ...
                           <div class="p-3">
                              <h2 class="my-0">Set New Password</h2>
                              ...
                              <form name="signUpForm" id="signUpForm">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                    <input placeholder="Enter Password" type="password" id="confirmPassword" name="confirmPassword"
                                       class="form-control">
                                       <div class="input-group-append">
                                          <span class="input-group-text" id="basic-addon2"><i class="icofont-eye" onclick="visibleHidePasswordFnc('confirmPassword',this)"></i></span>
                                       </div>
                                    </div>
                                 </div>
                                 <!-- <div class="form-group">
                     ...
                     <div class="osahan-verification" id="otp-verification-div" style="display:none;">
                        <div class="border-bottom p-3 d-flex align-items-center  justify-content-center">
                           <a href="/home" class="text-decoration-none text-dark d-flex align-items-center">
                              <img class="osahan-logo mr-2" src="/app/img/logo.png">
                              <h4 class="font-weight-bold text-danger m-0">RRMart</h4>
                        ...
                        <div class="osahan-form p-3 text-center my-3">
                           ...
                           <form action="get_started.html">
                              ...
                              <p><a href="/signin" class="text-decoration-none text-danger">Click Here to Login</a></p>
                     ...
                     <div class="osahan-verification" id="password-verification-div" style="display:none;">
                        <div class="border-bottom p-3 d-flex align-items-center  justify-content-center">
                           <a href="/home" class="text-decoration-none text-dark d-flex align-items-center">
                              <img class="osahan-logo mr-2" src="/app/img/logo.png">
                              <h4 class="font-weight-bold text-danger m-0">RRMart</h4>
                  ...
                  if (data.status) {
                     ...
                     if (data.response.isExistingCustomer != "0") {
                        setTimeout(() => {
                           ...
                           $("#contactId").val(data.response.contactId);
                        }, 1500);
                     } else {
                        setTimeout(() => {
         ...
         $.ajax({
            ...
            success: function (data) {
               if (data.status) {
                  ...
                  if (data.response.isExistingCustomer == "1") {
                     sendOTPFnc(mobNo)
                  } else {
                     $("#sign-up-div").hide();
                     $("#otp-verification-div").hide();
